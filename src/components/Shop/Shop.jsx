...
export default function Shop() {
  return (
    <div className="container">
      <h1 className=" text-center my-5">Shop by lifestyle</h1>
      <div className=" d-flex align-items-center justify-content-between text-center mb-5">
        <div>
          <div className="position-relative d-inline-block text-dark-emphasis bg-warning-subtl rounded-circle p-5 mb-4">
            <svg
              class="m-2"
          ...
          <h5 className="mb-3">Gluten-Free</h5>
          <p>Foods that don't contain gluten</p>
        </div>
        <div>
          <div className="position-relative d-inline-block text-dark-emphasis bg-warning-subt rounded-circle p-5 mb-4">
            <svg
              class="m-2"
              xmlns="http://www.w3.org/2000/svg"
              width="76"
          ...
          <h5 className="mb-3">Vegan</h5>
          <p>Vegetable based goodness</p>
        </div>
        <div>
          <div className="position-relative d-inline-block text-dark-emphasis bg-warning-su rounded-circle p-5 mb-4">
            <svg
              class="m-2"
              xmlns="http://www.w3.org/2000/svg"
              width="76"
          ...
          <h5 className="mb-3"> Planet based</h5>
          <p>Based on herbal ingredients</p>
        </div>
        <div>
          <div className="position-relative d-inline-block text-dark-emphasis bg-warning-s rounded-circle p-5 mb-4">
            <svg
              class="m-2"
              style={{ background: "rgb(46,32,39)" }}
              xmlns="http://www.w3.org/2000/svg"
              width="76"
              height="76"
              viewBox="0 0 76 76"
          ...
          <h5 className="mb-3">Keto</h5>
          <p> Good fats served in food</p>
        </div>
      </div>
    </div>
  );
